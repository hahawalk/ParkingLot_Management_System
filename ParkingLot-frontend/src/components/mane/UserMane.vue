...
<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item
        ><i class="iconfont icon-user-menu" style="margin: 5px; font-size: 22px"
          >用户信息管理</i
        ></el-breadcrumb-item
      >
    </el-breadcrumb>
        ...
        <el-table-column label="操作" align="center" fixed="right" width="200">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              type="warning"
              circle
              ><i class="iconfont icon-reset-button" style="font-size: 22px"></i
            ></el-button>
            <el-button
              v-if="scope.row.username != 'admin'"
...
export default {
  data() {
    ...
    return {
      ...
      editShow: false,
      editRules: {
        niek: [{ required: true, message: "请输入姓名", trigger: "blur" }],
        password: [
  ...
  methods: {
    ...
    async rePassword(uid) {
      ...
      if (re != "confirm") {
        ...
        axios.get("/api/user/resetPassword?uid=" + uid).then((res) => {
          if (res.data.data) {
